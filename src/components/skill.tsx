...
export const Skill = () => {
  return (
    <section className="py-16 text-center border-neon-b border-neon-green max-w-[1400px] mx-auto">
      <div className="sticky top-0 flex items-center justify-between border-neon-b border-neon-green max-w-[1400px] mx-auto px-1 py-4">
        <h2 className="flex items-center justify-center gap-3 text-2xl font-bold tracking-wider uppercase italic">
          技術スタック
